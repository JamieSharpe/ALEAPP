...
class ChromeMediaHistorySessionsPlugin(ArtefactPlugin):
    """
    """
    ...
    def __init__(self):
        ...
        self.name = 'Chrome Media History - Sessions'
        self.description = ''
    ...
    def _processor(self) -> bool:
        ...
        for file_found in self.files_found:
            ...
            if usageentries > 0:
                ...
                data_headers = (
                'Last Updated', 'Origin ID', 'URL', 'Position', 'Duration', 'Title', 'Artist', 'Album',
                'Source Title')  # Don't remove the comma, that is required to make this a tuple as there is only 1 element
                data_list = []
                for row in all_rows:

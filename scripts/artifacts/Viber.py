...
class ViberPlugin(ArtefactPlugin):
    """
    """
    ...
    #            break
        ...
        if usageentries > 0:
            ...
            report.start_artifact_report(self.report_folder, 'Viber - Call Logs')
            report.add_script()
        ...
        if usageentries > 0:
            ...
            report.start_artifact_report(self.report_folder, 'Viber - Contacts')
            report.add_script()
        ...
        if usageentries > 0:
            ...
            report.start_artifact_report(self.report_folder, 'Viber - Messages')
            report.add_script()
